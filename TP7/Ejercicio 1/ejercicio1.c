...
float calcularCosto(Pelicula p)
{
    if(p.fechaEstreno.anio == 2025 && (p.genero == 'Accion' || p.genero =='Ciencia Ficcion')){
        p.precioBase = p.precioBase + (p.precioBase*0.50);
    }else if(p.fechaEstreno.anio == 2024 && (p.genero == 'Romance' || p.genero == 'Terror')){

//VERSION 3. Para que el vendedor cargue distintos productos de distinta marca, este ejemplo es para 2 (los anteriores era para solo un tipo de producto y marca)
#include <stdio.h>
#include <stdlib.h>
#define MAX 100
...
int main (){
    venta articulo[2];//porque son dos productos diferentes de distintas marcas
